...
FontWeather("/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Font/weather.ttf", "weather", 100, False)
...
class MeteoMain(Screen):
    ...
    def updateInfo(self):
        ...
        try:
            ...
            if dom:
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Icon/%s.png' % str(weather_data['condition']['code'])
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Icon/%s.png' % str(weather_data['forecasts'][0]['code'])
                myicon = self.checkIcon(icon)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Icon/%s.png' % str(weather_data['forecasts'][1]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 150, 133, 0, 0, 0, 0)
                ...
                myicon = '/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Skin/1color.png'
    ...
    def get_Url(self):
        ...
        if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Config/Location_id"):	
             url2=open("/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Config/Location_id").read()				
        url = url+url2+'&u=c'
        return url
