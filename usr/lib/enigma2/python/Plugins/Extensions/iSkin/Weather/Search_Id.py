...
class WeatherList(Screen):       
    def __init__(self, session, Location):     
        ...
        skin = "/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Skin/WeatherList.xml"
    ...
    def go(self): 
       ...
       if Location_id and Region_id:	   
            iLocation = open('/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Config/Location_id','w')
            iLocation.write(str(Location_id))
            iLocation.close()
            iRegion = open('/usr/lib/enigma2/python/Plugins/Extensions/iSkin/Weather/Config/Region_id','w')
