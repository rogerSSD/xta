            ...
            try:
                ...
                if self.xd == True:
                    if self.white == True:
                        ...
                        if fileExists(line):
                            res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 0), size=(1150, 1), png=loadPNG(line)))
                            res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 49), size=(1150, 1), png=loadPNG(line)))
	                    ...
	                    res.append(MultiContentEntryText(pos=(960, 23), size=(200, 25), font=-1, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=user[i]))
                ...
                if self.xd == True:
                    if self.white == True:
                        ...
                        if fileExists(line):
                            res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 0), size=(1150, 1), png=loadPNG(line)))
                            res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 49), size=(1150, 1), png=loadPNG(line)))
                        res.append(MultiContentEntryText(pos=(0, 1),    size=(45, 48),  font=0, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=0, flags=RT_HALIGN_LEFT, text=''))
                        res.append(MultiContentEntryText(pos=(45, 0),   size=(800, 24), font=0, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=titel[i]))
                        res.append(MultiContentEntryText(pos=(45, 25),  size=(355, 24), font=0, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=post[i]))
                        res.append(MultiContentEntryText(pos=(400, 25), size=(560, 24), font=0, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=date[i]))
                        res.append(MultiContentEntryText(pos=(960, 25), size=(140, 24), font=0, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=user[i]))
                        if date[i] == 'Today':
                        ...
                        res.append(MultiContentEntryText(pos=(400, 25), size=(560, 25), font=0, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=date[i]))
                        res.append(MultiContentEntryText(pos=(960, 25), size=(140, 25), font=0, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=user[i]))
                        if date[i] == 'Today':
                            png = '/usr/lib/enigma2/python/Plugins/Extensions/Xtrend/pic/forum_new-48.png'
                            if fileExists(png):
                                res.append(MultiContentEntryPixmapAlphaTest(pos=(5, 9), size=(32, 32), backcolor=1447446, backcolor_sel=1447446, png=loadPNG(png)))
                    ...
                    if fileExists(line):
                        res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 0), size=(1150, 1), png=loadPNG(line)))
                        res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 49), size=(1150, 1), png=loadPNG(line)))
                    res.append(MultiContentEntryText(pos=(0, 0),    size=(45, 48),   font=-1, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=0, flags=RT_HALIGN_LEFT, text=''))
                    res.append(MultiContentEntryText(pos=(45, 1),   size=(1140, 25), font=-1, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=titel[i]))
                    res.append(MultiContentEntryText(pos=(45, 23),  size=(765, 25),  font=-1, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=post[i]))
                    res.append(MultiContentEntryText(pos=(810, 23), size=(150, 25),  font=-1, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=date[i]))
                    res.append(MultiContentEntryText(pos=(960, 23), size=(200, 25),  font=-1, backcolor=16777215, color=0, backcolor_sel=1447446, color_sel=13903912, flags=RT_HALIGN_LEFT, text=user[i]))
                    if date[i] == 'Today':
                        png = '/usr/lib/enigma2/python/Plugins/Extensions/Xtrend/pic/forum_new-48.png'
                        if fileExists(png):
                            res.append(MultiContentEntryPixmapAlphaTest(pos=(5, 9), size=(32, 32), backcolor=16777215, backcolor_sel=16777215, png=loadPNG(png)))
                    ...
                    if fileExists(line):
                        ...
                        res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 49), size=(1150, 1), png=loadPNG(line)))
                    res.append(MultiContentEntryText(pos=(45, 1),   size=(1140, 25), font=-1, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=titel[i]))
                    res.append(MultiContentEntryText(pos=(45, 23),  size=(765, 25),  font=-1, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=post[i]))
                    res.append(MultiContentEntryText(pos=(810, 23), size=(150, 25),  font=-1, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=date[i]))
                    res.append(MultiContentEntryText(pos=(960, 23), size=(200, 25),  font=-1, backcolor=1447446, color=16777215, backcolor_sel=1447446, color_sel=15022127, flags=RT_HALIGN_LEFT, text=user[i]))
                    if date[i] == 'Today':
                        png = '/usr/lib/enigma2/python/Plugins/Extensions/Xtrend/pic/forum_new-48.png'
